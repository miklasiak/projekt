...
protected:
	...
	void event_PauseEvents(uint32 EventType);
	void event_ResumeEvents(uint32 EventType);
...
typedef std::list<TimedEvent*> TimedEventQueue;
typedef std::list<TimedEvent*> TimedEventSet;
...
public:
	...
	TimedEventSet m_deletePool;
	Mutex m_deletePoolLock;

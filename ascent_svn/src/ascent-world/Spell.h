...
enum SPELL_MODIFIER_TYPE
{
	...
	SMT_ATTACK_POWER_AND_DMG_BONUS=3,// this should effect the FIRST effect of the spell // NOT GOOD 
...
public:
	...
	uint32 school; //could possible change for every target from an aoe, for example

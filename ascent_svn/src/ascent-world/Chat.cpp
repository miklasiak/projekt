...
void CommandTableStorage::Init()
{
	...
	static ChatCommand NPCCommandTable[] =
	{
		...
		{ "castself",	'n', &ChatHandler::HandleNpcCastSelfCommand,	   ".npc castself <SpellId> - Makes the npc cast SpellId on himself", NULL, 0, 0, 0 },
		{ "castme",	'n', &ChatHandler::HandleNpcCastMeCommand,	   ".npc castme<SpellId> - Makes the npc cast SpellId on you", NULL, 0, 0, 0 },
	...
	static ChatCommand commandTable[] = {
		...
		//{ "pannounce",   'u', &ChatHandler::HandlePlayerAnnounceCommand, "Sends widescreen message to specified player.", NULL, 0, 0, 0},
		...
		{ "ws", 'z', &ChatHandler::HandleWSCommand, ".ws X Y - Sets worldstate X to Y.", NULL, 0, 0, 0},

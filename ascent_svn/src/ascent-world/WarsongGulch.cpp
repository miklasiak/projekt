...
WarsongGulch::WarsongGulch(MapMgr * mgr, uint32 id, uint32 lgroup, uint32 t) : CBattleground(mgr, id, lgroup, t)
{
	...
	m_homeFlags[0]->SetByte(GAMEOBJECT_BYTES_1, 0, 24);
	...
	m_homeFlags[1]->SetByte(GAMEOBJECT_BYTES_1, 0, 24);
...
void WarsongGulch::OnCreate()
{
	...
	gate->SetFloatValue(GAMEOBJECT_PARENTROTATION,-0.004956f);
	...
	gate->SetFloatValue(GAMEOBJECT_PARENTROTATION,0.1575096f);

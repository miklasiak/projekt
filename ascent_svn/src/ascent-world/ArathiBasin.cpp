...
void ArathiBasin::SpawnBuff(uint32 x)
{
	...
	if(m_buffs[x] == NULL)
	{
		...
		m_buffs[x]->SetByte(GAMEOBJECT_BYTES_1, 0, 6);
...
void ArathiBasin::SpawnControlPoint(uint32 Id, uint32 Type)
{
	...
	if(m_controlPointAuras[Id] == NULL)
	{
		...
		m_controlPointAuras[Id]->SetByte(GAMEOBJECT_BYTES_1, 0, 6);
...
void ArathiBasin::OnCreate()
{
	...
	gate->SetUInt64Value(GAMEOBJECT_ROTATION,0.0129570f);
	gate->SetFloatValue(GAMEOBJECT_PARENTROTATION,-0.0602880f);
	gate->SetFloatValue(GAMEOBJECT_PARENTROTATION_2,0.3449600f);
	gate->SetFloatValue(GAMEOBJECT_PARENTROTATION_3,0.9365900f);
	gate->PushToWorld(m_mapMgr);
	m_gates.push_back(gate);

	// horde gate
	gate = SpawnGameObject(180256, 529, 708.0902710f, 708.4479370f, -17.3898964f, -2.3910990f, 32, 114, 1.5699990f);
	gate->SetUInt64Value(GAMEOBJECT_ROTATION,0.0502910f);
	gate->SetFloatValue(GAMEOBJECT_PARENTROTATION,0.0151270f);
	gate->SetFloatValue(GAMEOBJECT_PARENTROTATION_2,0.9292169f);
	gate->SetFloatValue(GAMEOBJECT_PARENTROTATION_3,-0.3657840f);
	gate->PushToWorld(m_mapMgr);
	m_gates.push_back(gate);
...
void ArathiBasin::EventUpdateResources(uint8 Team)
{
...
void ArathiBasin::CaptureControlPoint(uint32 Id, uint8 Team)
{
	...
	{
		// first
		sEventMgr.AddEvent(this,&ArathiBasin::EventUpdateResources, Team, EVENT_AB_RESOURCES_UPDATE_TEAM_0+Team, ResourceUpdateIntervals[1], 0,

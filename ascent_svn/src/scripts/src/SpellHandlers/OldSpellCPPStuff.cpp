...
void SetupOldSpellCPPSuff(ScriptMgr * mgr)
{
	...
	//Arcane Missiles
	mgr->register_spell_script(5143, &DummyPeriodicTrigger::Create);
	mgr->register_spell_script(5144, &DummyPeriodicTrigger::Create);
	mgr->register_spell_script(5145, &DummyPeriodicTrigger::Create);
	mgr->register_spell_script(8416, &DummyPeriodicTrigger::Create);
	mgr->register_spell_script(8417, &DummyPeriodicTrigger::Create);
	mgr->register_spell_script(10211, &DummyPeriodicTrigger::Create);
	mgr->register_spell_script(10212, &DummyPeriodicTrigger::Create);
	mgr->register_spell_script(25345, &DummyPeriodicTrigger::Create);
	mgr->register_spell_script(27075, &DummyPeriodicTrigger::Create);
	mgr->register_spell_script(38699, &DummyPeriodicTrigger::Create);
	mgr->register_spell_script(38704, &DummyPeriodicTrigger::Create);
	//Tame Beast
	mgr->register_spell_script(1515, &DummyPeriodicTrigger::Create);

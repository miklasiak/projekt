...
struct LuaServerHookBinding { const char * Functions[NUM_SERVER_HOOKS]; };
...
private:
	...
	typedef HM_NAMESPACE::hash_map<uint32, LuaServerHookBinding> ServerHookBindingMap;
	...
	ServerHookBindingMap m_sh_hookBinding;
...
public:
	...
	void RegisterServerHookEvent(uint32 Id, uint32 Event, const char * FunctionName);

...
#ifdef WIN32
	_player->BroadcastMessage("Powered by: %sArcEmu r%u by %sEvolution-Cores %s(http://evolution-cores.ath.cx)", MSG_COLOR_WHITE, BUILD_REVISION, MSG_COLOR_RED, MSG_COLOR_LIGHTBLUE);		
#else
	_player->BroadcastMessage("Powered by: %sArcEmu r%u by %sEvolution-Cores %s(http://evolution-cores.ath.cx)", MSG_COLOR_WHITE, BUILD_REVISION, MSG_COLOR_RED, MSG_COLOR_LIGHTBLUE);
#endif
